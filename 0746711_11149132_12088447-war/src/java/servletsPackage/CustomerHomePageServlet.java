...
public class CustomerHomePageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Customer Homepage</h1>");
        out.println("<br/>");
        out.println("<a href=SearchByIdPageServlet>Search for product by ID</a>");
        out.println("<br/>");
        out.println("<br/>");
        out.println("<a href=SearchByNamePageServlet>Search for product by Name</a>");
        out.println("<br/>");
